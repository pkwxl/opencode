...
- 阶段台账 docs/phases.md: 各已完成阶段的归档目录与交接文档索引;
- 各阶段交接文档 docs/handovers/R<N>-<字母>-<名称>.md: 优先细读(该阶段的蒸馏
  结论);各阶段归档目录 docs/phases/<字母>-<名称>/ 内是阶段 PLAN.md 快照(任务、
...
1. 只读勘察: 读 docs/phases.md 与 docs/handovers/ 内各交接文档,把握迁移全貌;
   需要细节时按产物索引取用归档 PLAN 与原始产物,不要跳过尚未读过的阶段;
